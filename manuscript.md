...
톰은 화가 머리끝까지 났지만 제리를 구하기 위한 묘수를 생각하기 위해 냉정하게 이성을 유지하려고 애썼다.
```
수많은 고양이들 사이에서 어떻게하면 제리를 구해낼 수 있지?
```
그때 톰의 머리속에 기막힌 묘수가 생각났다.
```
그 쥐는 실험용 쥐라 함부러 하면 안되, 나도 군침만 흘리면서 먹지는 못하고 있단 말이야
```
실험용 쥐라는 말에 고양이들이 웅성거리기 시작했다.
```
그럼 저걸 먹으면 죽을수도 있다는건가??
그냥 버리고 다른거 먹자 잭...
```
잭도 내심 고민하는 표정이었다. 톰은 이때를 놓치지 않고 고양이들이 들리게 큰 소리로 외쳣다.
```
빨리 돌아가자 제리, 곧 주사 맞을 시간이야
```
## 절정
